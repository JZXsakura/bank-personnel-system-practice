...
| event_type  | VARCHAR(100) | Тип кадрового события |
| event_date  | DATE         | Дата события          |

Таблица предназначена для хранения кадровых событий сотрудника (приём на работу, перевод, отпуск, увольнение и другие изменения кадрового статуса).
